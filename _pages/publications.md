...
| [C123] | Youwei Xiao, Yuyang Zou, Yansong Xu, Yuhao Luo, Yitian Sun, Chenyun Yin, Ruifan Xu, Renze Chen, **Yun Liang**. “APS: Open-Source Hardware-Software Co-Design Framework for Agile Processor Specialization " to appear in the proceeding of the International Conference on Computer Aided Design (**ICCAD), Oct. 2025. (Invited paper**) [Code](https://github.com/pku-liang/aps) . |
| [C122] | Weijie Peng, Youwei Xiao, Yuyang Zou, Zizhang Luo, **Yun Liang**. "Clay: High-level ASIP Framework for Flexible Microarchitecture-Aware Instruction Customization”, to appear in the proceeding of the International Conference on Computer Aided Design (**ICCAD**), Oct. 2025. [Code](https://github.com/pku-liang/clay) . |
