...
| [C130] |	Zihao Zheng, Xiuping Cui, Size Zheng, Maoliang Li, Jiayu Chen, **Yun Liang**, Xiang Chen. "DynaMo: Runtime Switchable Quantization for MoE with Cross-Dataset Adaptatio", to appear in the proceedings of the Design Automation and Test in Europe (**DATE**), 2026. |
| [C129] |	ChengruiZhang, Liancheng Jia, Chu Wang, Tianqi Li, Renze Chen, Xuping Cui, Size Zheng, Shengen Yan. Xiuhong Li, Yu Wang. Xiang Chen, Yun  Liang. "LATlAS: A General Architecture-0perator Model for Spatial Accelerators with Complex Topology and Memory Hierarchy", to appear in the proceedings of the Design Automation and Test in Europe (**DATE**), 2026. |
| [C128] |	Xiuping Cui, Chengrui Zhang, Xiang Chen, **Yun Liang**. "Dolphium: Co-Optimizing Quantization Dataflow and Paradigms on Poly-Hierarchical NPUs ", to appear in the proceedings of the Design Automation and Test in Europe (**DATE**), 2026. |
...
| [C127] |	Yangjie Zhou, Wenting Sehn, Jingwen Leng, Shuwen Lu, Zihan Liu, Weihao Cui, Zhendong Zhang,  Wencong Xiao, Baole Ai, Yong Li, Wei Lin, Deze Zeng, **Yun Liang**, Quan Chen, Ning Liu, Minyi Guo. "Voyager : Input-Apaptive Algebraic Transformations for High-Performance Graph Neural Networks ", to appear in the proceedings of ACM International Conference on Architectural Support for Programming Languages and Operating Systems (**ASPLOS**), 2026. |
| [C126] |	Hanyu Zhang, Fangxu Guo , Liqiang Lu, Long Wang, Yunfei Du, Zhe Wang, Jinghan Zhang, Jie Zhang, Chenli Xue , Chengpeng Wu, Ziyi Zhang, **Yun Liang**, Size Zheng, Jianwei Yin. "SnakeMan: Applying Relation-centric Notation to Model and Optimize Data Swizzle in the Cache of Modern NPU", to appear in the proceedings of IEEE International Symposium on High Performance Computer Architecture (**HPCA**), 2026. |
...
| [C122] | Weijie Peng, Youwei Xiao, Yuyang Zou, Zizhang Luo, **Yun Liang**. "Clay: High-level ASIP Framework for Flexible Microarchitecture-Aware Instruction Customization”, in the proceeding of the International Conference on Computer Aided Design (**ICCAD**), Oct. 2025. [Code](https://github.com/pku-liang/clay) . |
...
| [C118] | Xiaochen Hao, Hao Luo, Chu Wang, Chao Yang, **Yun Liang**. "Telos: A Dataflow Accelerator for Sparse Triangular Solver of Partial Differential Equations", in the proceedings of International Symposium on Computer Architecture (**ISCA**), June 2025. [Code](https://github.com/pku-liang/telos) . |
