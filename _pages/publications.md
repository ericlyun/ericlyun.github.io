...
| [C93] |	Size Zheng, Siyuan Chen, Siyuan Gao, Liancheng Jia, Guangyu Sun, Runsheng Wang, and ** Yun Liang**.  "TileFlow: A Framework for Modeling Fusion Dataflow via Tree-based Analysis", to appear in the proceedings of the 56th International Symposium on Microarchitecture (**MICRO**), 2023. |
| [C92] |	Kexing Zhou, ** Yun Liang**, Yibo Lin, Runsheng Wang, and Ru Huang. "Khronos: Fusing Memory Access for Improved Hardware RTL Simulation", to appear in the proceedings of the 56th International Symposium on Microarchitecture (**MICRO**), 2023.
| [C91] |	Yifan Che, Zaiwen Wen, ** Yun Liang**, and Yibo Lin." Stronger Mixed-Size Placement Backbone Considering Second-Order Information",  to appear in the proceeding of the International Conference on Computer Aided Design (**ICCAD**), Oct. 2023. |
| [C90] |	Shuzhang Zhong, Meng Li, ** Yun Liang**, Runsheng Wang and Ru Huang.  "Memory-aware Scheduling for Complex Wired Networks with Iterative Graph Optimization",  to appear in the proceeding of the International Conference on Computer Aided Design (**ICCAD**), Oct. 2023. |
| [C89] |	Xiuping Cui, Size Zheng, Tianyu Jia, Le Ye and ** Yun Liang**. "ARES: A Mapping Framework of DNNs towards Diverse PIMs with General Abstractions", to appear in the proceeding of the International Conference on Computer Aided Design (**ICCAD**), Oct. 2023. |
| [C88] |	Xiaochen Hao, Zijian Ding, Jieming Yin, Yuan Wang and ** Yun Liang**. "Title: Monad: Towards Cost-effective Specialization for Chiplet-based Spatial Accelerators", to appear in the proceeding of the International Conference on Computer Aided Design (**ICCAD**), Oct. 2023. |
| [C87] |	Zizhang Luo, Liqiang Lu, Yichen Jin, Liancheng Jia, ** Yun Liang**. "TITLE: Calabash: Accelerating Attention using a Systolic Array Chain on FPGAs", to appear in the proceedings of the International Conference on Field-Programmable Logic and Applications (**FPL**), Sep 2023. |
...
| [C55] | Xiuhong Li, **Yun Liang**, Shengen Yan, Liancheng Jia, Yinghan li. " A Coordinated Tiling and Batching Framework for Efficient GEMM on GPUs," in the proceedings of *Principles and Practice of Parallel Programming (**PPoPP**)*, February 2019. <span style="color:red">**Best Paper Award Nomination.**</span> |
